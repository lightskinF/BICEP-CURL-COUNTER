...
COME USARLO: basta runnare il programma "hey_youps.py", si aprirà la camera, posizionarsi in modo che spalle, braccia e polso siano visibili dalla camera per calcolarne l'angolo e permettere il conteggio delle ripetizioni valide. Quando si vuole terminare il programma, basta premere il tasto "q" da tastiera. CLICCARE AL LINK SOPRA per vedere la demo!
